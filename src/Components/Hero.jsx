    ...
    <div className='max-w-[1150px] mx-auto pt-4 '>
      ...
      <div className='flex flex-col sm:flex-row justify-between items-center pt-[40px]'>
        <div className='max-w-[500px]' >
            ...
            <input type='text' placeholder='Search for location' className=' border border-gray-400 focus:outline-none w-[280px] rounded-l-md  p-1.5'/>
                <button className='bg-[#A02279] w-[170px] p-2  rounded-r-md text-white'>Search</button>
                </div>
            </div>
        </div>
